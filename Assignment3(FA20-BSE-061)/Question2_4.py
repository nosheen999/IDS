...
print(f"excluding two attributes can potentially lead to a decrease in the model's accuracy and an increase in the number of incorrect classifications. This highlights the importance of carefully considering the relevance and impact of each attribute when selecting features for machine learning tasks.")
